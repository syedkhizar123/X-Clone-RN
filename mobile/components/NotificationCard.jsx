        ...
        <View className='border-b border-gray-100 bg-white'>
            <View className='flex-row p-4'>
                <View className='relative mr-3 '>
                    ...
                    <View className='-bottom-1 -right-1 size-6 bg-white items-center justify-center '>
                        {getNotificationIcon()}
                    </View>
                </View>
                ...
                <View className='flex-1'>
                    ...
                    {notification.comment && (
                        <View className='bg-blue-50 rounded-lg p-3 mb-2'>
                            ...
                            <Text className='text-gray-700 text-sm' numberOfLines={2}>{notification.comment.content}</Text>
                        </View>
                    )}
